# VSTEP Writing Sources Registry

## Overview
Stores authenticated source citations, original prompt cards, word count limits, and benchmark model responses for VSTEP Writing tests (Task 1: Letter/Email 120 words, Task 2: Essay 250 words / 60 minutes).
