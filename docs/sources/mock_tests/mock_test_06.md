# VSTEP Full Mock Test 06 (ULIS Composition)

## Metadata
- **Exam Title**: Đề Thi Thử Toàn Diện VSTEP Bậc 3–5 (Bộ 06)
...
- **Listening (40 min)**: [vstep_listening_mock_06](../listening/README.md)
- **Reading (60 min)**: [ulis_reading_set6.md](../reading/ulis_reading_set6.md)
- **Writing (60 min)**: [ulis_writing_tests.md](../writing/ulis_writing_tests.md#test-06)
- **Speaking (12 min)**: [speakingBank.ts](../../../src/features/speaking/data/speakingBank.ts)

### Listening Module (40 min / 35 Questions)
- **Source**: "7 Vstep Tests B1-B2-C1 Full Key" (NXB ĐHQGHN, 2019), Test 6
- **Runtime Code**: `src/features/listening/data/mockTests/mockTest06.ts` (`vstep-test-6.mp3`)
...
- **Source**: [`docs/sources/reading/ulis_reading_set6.md`](file:///d:/program/vstep/docs/sources/reading/ulis_reading_set6.md)
- **Runtime Code**: `src/features/reading/data/mockTests/ulisReadingTest06.ts`
...
- **Source**: [`docs/sources/writing/ulis_writing_tests.md#test-06`](file:///d:/program/vstep/docs/sources/writing/ulis_writing_tests.md)
- **Runtime Code**: `src/features/writing/data/mockTests/ulisWritingTest06.ts` (`ULIS_WRITING_TEST_06_TASK1`, `ULIS_WRITING_TEST_06_TASK2`)
- **Tasks**: Task 1 (Letter: Training course request, $\ge 120$ words) + Task 2 (Essay: Video game impact on children, $\ge 250$ words).
