# VSTEP Full Mock Test 04 (ULIS Composition)

## Metadata
- **Exam Title**: Đề Thi Thử Toàn Diện VSTEP Bậc 3–5 (Bộ 04)
...
- **Listening (40 min)**: [vstep_listening_mock_04](../listening/README.md)
- **Reading (60 min)**: [ulis_reading_set4.md](../reading/ulis_reading_set4.md)
- **Writing (60 min)**: [ulis_writing_tests.md](../writing/ulis_writing_tests.md#test-04)
- **Speaking (12 min)**: [speakingBank.ts](../../../src/features/speaking/data/speakingBank.ts)

### Listening Module (40 min / 35 Questions)
- **Source**: "7 Vstep Tests B1-B2-C1 Full Key" (NXB ĐHQGHN, 2019), Test 4
- **Runtime Code**: `src/features/listening/data/mockTests/mockTest04.ts` (`vstep-test-4.mp3`)
...
- **Source**: [`docs/sources/reading/ulis_reading_set4.md`](file:///d:/program/vstep/docs/sources/reading/ulis_reading_set4.md)
- **Runtime Code**: `src/features/reading/data/mockTests/ulisReadingTest04.ts`
...
- **Source**: [`docs/sources/writing/ulis_writing_tests.md#test-04`](file:///d:/program/vstep/docs/sources/writing/ulis_writing_tests.md)
- **Runtime Code**: `src/features/writing/data/mockTests/ulisWritingTest04.ts` (`ULIS_WRITING_TEST_04_TASK1`, `ULIS_WRITING_TEST_04_TASK2`)
- **Tasks**: Task 1 (Letter: New job, $\ge 120$ words) + Task 2 (Essay: Taxing private cars for public transit, $\ge 250$ words).
