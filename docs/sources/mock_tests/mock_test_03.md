# VSTEP Full Mock Test 03 (ULIS Composition)

## Metadata
- **Exam Title**: Đề Thi Thử Toàn Diện VSTEP Bậc 3–5 (Bộ 03)
...
- **Source**: "7 Vstep Tests B1-B2-C1 Full Key" (NXB ĐHQGHN, 2019), Test 3
- **Runtime Code**: `src/features/listening/data/mockTests/mockTest03.ts` (`vstep-test-3.mp3`)
...
- **Source**: [`docs/sources/reading/ulis_reading_set3.md`](file:///d:/program/vstep/docs/sources/reading/ulis_reading_set3.md)
- **Runtime Code**: `src/features/reading/data/mockTests/ulisReadingTest03.ts`
...
- **Source**: Authentic Exam Session (May 20)
- **Runtime Code**: `src/features/speaking/data/speakingBank.ts` (`SPEAKING_EXAM_MAY_20`)
