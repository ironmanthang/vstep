# VSTEP Full Mock Test 05 (ULIS Composition)

## Metadata
- **Exam Title**: Đề Thi Thử Toàn Diện VSTEP Bậc 3–5 (Bộ 05)
...
- **Source**: "7 Vstep Tests B1-B2-C1 Full Key" (NXB ĐHQGHN, 2019), Test 5
- **Runtime Code**: `src/features/listening/data/mockTests/mockTest05.ts` (`vstep-test-5.mp3`)
...
- **Source**: [`docs/sources/reading/ulis_reading_set5.md`](file:///d:/program/vstep/docs/sources/reading/ulis_reading_set5.md)
- **Runtime Code**: `src/features/reading/data/mockTests/ulisReadingTest05.ts`
