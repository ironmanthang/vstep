...
- **Thiết kế Tối giản Không Cuộn trên Di động (Mobile Zero-Scroll Minimalism)**: Các trang điều hướng chính (Trang chủ `/`, Luyện kỹ năng `/practice`, Hồ sơ `/profile`) được tối ưu hóa hiển thị trọn vẹn trong khung nhìn dọc ~500px của điện thoại mà không cần cuộn trang. Trang chủ dùng 3 thẻ hàng ngang nhỏ gọn (~54px) và thanh tiến độ 3 cột; trang Luyện kỹ năng bố trí lưới 2x2 rút gọn chỉ gồm icon, tên kỹ năng tiếng Anh và huy hiệu; trang Hồ sơ gom toàn bộ thông tin tài khoản và nút Đặt lại Deck vào 1 thẻ duy nhất.
