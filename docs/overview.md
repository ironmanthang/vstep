...
- **Chế độ Luyện tập Thân thiện (Skill Building Mode - Trọng tâm)**:
  ...
  - Học vi mô (Micro-learning): Flashcard SRS 3.000 từ cốt lõi duy trì thói quen học mỗi ngày trên điện thoại.
...
- **Nguồn Dữ liệu & Ngữ liệu Cốt lõi**:
  - 3.000 từ vựng và bài đọc/nghe trích xuất trực tiếp từ các bộ đề thi thật và đề minh họa chuẩn của **ULIS (Trường ĐH Ngoại ngữ – ĐHQGHN)**, **HNUE** và **Trường ĐH Sư phạm TP.HCM** phân loại theo 8 chủ đề VSTEP chuẩn Bộ GD&ĐT (xem chi tiết tại [exam_format.md](file:///d:/program/vstep/docs/exam_format.md)).
...
- [foundation_drills.md](file:///d:/program/vstep/docs/features/foundation_drills.md): Flashcard SRS 3.000 từ trích xuất đề thi thật ULIS/HNUE/HCMUE theo 8 chủ đề.
