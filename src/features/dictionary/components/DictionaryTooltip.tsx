...
import { lookupDictionary, type DictEntry } from '../../reading/data/dictionaryVi';
import { sanitizeLookupWord } from '../utils/wordCoordinates';
...
export const DictionaryTooltip: React.FC<DictionaryTooltipProps> = ({
  ...
  const cleanWord = useMemo(() => (word ? sanitizeLookupWord(word) : ''), [word]);
