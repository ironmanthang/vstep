...
export const ULIS_WRITING_TEST_02_TASK2: WritingPrompt = {
  ...
  "sample_response": {
    "band": "B1",
    "text": "We cannot deny that more and more people are becoming interested in online shopping. However, there are both good and bad things of online shopping.\n\nOn the one hand, online shopping helps us save a lot of time and money. We do not have to go to shops to buy things. We can stay at home and buy a lot of things. We just have to turn on the computer, look for things online and then we order and wait, someone can bring the things to your house. Also, this can help us save money because we do not spend money on travelling to shops.\n\nOn the other hand, however, online shopping has disadvantages. Firstly, We may buy bad things. They are not as good as we think. And we may lose money because we have to give someone our information of the account. And if we buy too many things online, we can spend too much money.\n\nTo sum up, online shopping has both good and bad things",
    "analysis_vi": "Bài viết đạt chuẩn B1 nhờ việc sử dụng các cấu trúc câu đơn và câu ghép cơ bản, các từ nối quen thuộc (On the one hand, On the other hand, To sum up) và từ vựng vừa đủ để trình bày rõ ràng ưu - nhược điểm của việc mua sắm trực tuyến."
  }
};

export const ULIS_WRITING_TEST_02 = {
  id: 'ulis_writing_test_02',
  test_number: 2,
  title: 'ULIS Authentic VSTEP Writing Test 02',
